...
IMAPClient.prototype.listMessageChanges = function (modseq, callback) {
    this.fetch('1:*', 'UID FLAGS X-GM-LABELS ENVELOPE', 'CHANGEDSINCE ' + modseq, callback);
};
...
IMAPClient.prototype.fetchNewMessages = function (lastSeenUID, modseq, callback) {
    this.fetch(lastSeenUID + ':*', 'UID FLAGS X-GM-LABELS ENVELOPE', modseq ? 'CHANGEDSINCE ' + modseq : '', callback);
};
